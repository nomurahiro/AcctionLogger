...
<div class="row">
	...
	<div class="col-8">
		...
		<form class="form-addaction" action="/ActionLogger/addactivites"
			method="post">
			...
			<div class="mb-3">
				...
				<textarea class="form-control" id="reason" name="reason"
					placeholder="理由" rcols="60" rows="5" style="resize: none;" required></textarea>
			...
			<div class="mb-3">
				...
				<textarea class="form-control" id="remarks" name="remarks"
					placeholder="備考" cols="60" rows="5" style="resize: none;"></textarea>
